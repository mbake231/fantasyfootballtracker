    ...
    <div><br></br>
      <div id="dropdown" style={{textAlign:'left'}}>
        ...
        <Form.Control style={{display:'inline',width:'20%'}} value={this.state.week} as="select" onChange={this.handleChange.bind(this)}>
          ...
          <option value ="5" onChange={e => {this.updateWeek()}}>5</option>
          <option value ="6" onChange={e => {this.updateWeek()}}>6</option>
          <option value ="7" onChange={e => {this.updateWeek()}}>7</option>
          <option value ="8" onChange={e => {this.updateWeek()}}>8</option>
          <option value ="9" onChange={e => {this.updateWeek()}}>9</option>
          <option value ="10" onChange={e => {this.updateWeek()}}>10</option>
          <option value ="11" onChange={e => {this.updateWeek()}}>11</option>
          <option value ="12" onChange={e => {this.updateWeek()}}>12</option>
          <option value ="13" onChange={e => {this.updateWeek()}}>13</option>
          <option value ="14" onChange={e => {this.updateWeek()}}>14</option>
          <option value ="15" onChange={e => {this.updateWeek()}}>15</option>
